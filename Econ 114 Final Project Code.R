#Conor McCaffery
#Econ 114 Research Project Script

setwd("C:/Users/Conor/Downloads")
library(readxl)
df <- read_excel("C:/Users/Conor/Downloads/Final project data.xlsx",sheet="Macrohistory")
...
library(forecast)
ts_data <- ts(df, start = 1968, frequency = 1)
arimax_model <- arima(ts_data,order=c(1,0,0))
